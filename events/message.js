...
module.exports = class MessageEvent extends BaseEvent {
  // Create our message event class
  constructor() {
  ...
  async run(client, message) {
    ...
    if (active === "on") {
      if (
        // Check if the message ends with "quoi" (what in english) (there is also the sms way)
        ...
        // Check if the message ends with "oui" (yes in english) (there is also the sms way)
